...
export default function ExamPage() {
  ...
  const handleStartExam = async () => {
    ...
    try {
      ...
      if (data.error) {
        addToast({ type: "error", title: "Exam Error", description: data.error });
        setExamState("idle");
        return;
      }
      ...
      addToast({ type: "error", title: "Exam Failed", description: "Failed to generate exam. Check your AI API key." });
      setExamState("idle");
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addToast({ type: "error", title: "Grading Failed", description: "Failed to grade exam. Please try again." });
      setExamState("active");
    }
  };

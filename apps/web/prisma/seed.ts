...
async function main() {
  ...
  const quests = [
    // ===== HEALTH & VITALITY =====
    { title: "Morning Workout (30+ min)", category: "health", difficulty: "normal", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Walk 8,000+ Steps", category: "health", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 10, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Drink 8 Glasses of Water", category: "health", difficulty: "normal", tier: "daily", xpBase: 30, goldBase: 5, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Sleep Before 11:30 PM", category: "health", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Cook a Healthy Meal", category: "food", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 10, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "No Junk Food Today", category: "food", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Stretch / Yoga (15 min)", category: "health", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 8, statTarget: "vitality", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Meditate (10 min)", category: "mental", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },

    // ===== JOB SEARCH & HUSTLE =====
    { title: "Apply to 3 Jobs", category: "jobs", difficulty: "hard", tier: "daily", xpBase: 100, goldBase: 25, statTarget: "hustle", statGain: 3, isDaily: true, unlocksAtLevel: 1 },
    { title: "Tailor Resume for a Role", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Write a Cover Letter", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 70, goldBase: 15, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Network: Send 3 LinkedIn Messages", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Practice STAR Interview Answer", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 3 },
    { title: "Research 2 Target Companies", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 10, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Update LinkedIn Profile Section", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Follow Up on Application", category: "jobs", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 12, statTarget: "hustle", statGain: 2, isDaily: true, unlocksAtLevel: 1 },

    // ===== STUDY & INTELLIGENCE =====
    { title: "Solve 1 LeetCode Problem", category: "learning", difficulty: "normal", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "intel", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Study Cert Material (1 hr)", category: "learning", difficulty: "hard", tier: "daily", xpBase: 100, goldBase: 25, statTarget: "intel", statGain: 3, isDaily: true, unlocksAtLevel: 1 },
    { title: "Complete 1 SQL Challenge", category: "learning", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "intel", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Read 30 Pages (Tech Book)", category: "learning", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 10, statTarget: "intel", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Watch Tech Tutorial (45 min)", category: "learning", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "intel", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Write Technical Notes / Blog", category: "learning", difficulty: "normal", tier: "daily", xpBase: 70, goldBase: 18, statTarget: "intel", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Practice System Design (30 min)", category: "learning", difficulty: "hard", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "intel", statGain: 3, isDaily: true, unlocksAtLevel: 5 },
    { title: "ML / AI Concept Deep Dive", category: "learning", difficulty: "hard", tier: "daily", xpBase: 90, goldBase: 22, statTarget: "intel", statGain: 3, isDaily: true, unlocksAtLevel: 5 },

    // ===== FINANCIAL DISCIPLINE & WEALTH =====
    { title: "Log Every Expense Today", category: "finance", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 12, statTarget: "wealth", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "No Unnecessary Spending", category: "finance", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "wealth", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    ...
    { title: "Review Budget vs Actual", category: "finance", difficulty: "normal", tier: "weekly", xpBase: 40, goldBase: 10, statTarget: "wealth", statGain: 2, isDaily: false, unlocksAtLevel: 1 },
    { title: "Cook Instead of Ordering", category: "food", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 12, statTarget: "wealth", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Earn Side Income Today", category: "finance", difficulty: "hard", tier: "daily", xpBase: 120, goldBase: 30, statTarget: "wealth", statGain: 3, isDaily: true, unlocksAtLevel: 5 },
    { title: "Cancel Unused Subscription", category: "finance", difficulty: "normal", tier: "custom", xpBase: 60, goldBase: 15, statTarget: "wealth", statGain: 2, isDaily: false, unlocksAtLevel: 1 },
    { title: "No Coffee Shop Purchase", category: "finance", difficulty: "normal", tier: "daily", xpBase: 30, goldBase: 8, statTarget: "wealth", statGain: 2, isDaily: true, unlocksAtLevel: 1 },

    // ===== FOCUS & DISCIPLINE =====
    { title: "Pomodoro Session (4x25 min)", category: "focus", difficulty: "hard", tier: "daily", xpBase: 100, goldBase: 25, statTarget: "focus", statGain: 3, isDaily: true, unlocksAtLevel: 1 },
    { title: "No Social Media Until 12 PM", category: "focus", difficulty: "normal", tier: "daily", xpBase: 60, goldBase: 15, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Deep Work Block (2 hrs)", category: "focus", difficulty: "hard", tier: "daily", xpBase: 120, goldBase: 30, statTarget: "focus", statGain: 3, isDaily: true, unlocksAtLevel: 1 },
    { title: "Morning Routine Complete", category: "focus", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 12, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Evening Review (15 min)", category: "focus", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Phone Screen Time < 3 hrs", category: "focus", difficulty: "normal", tier: "daily", xpBase: 50, goldBase: 12, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Inbox Zero", category: "focus", difficulty: "normal", tier: "daily", xpBase: 40, goldBase: 10, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },
    { title: "Plan Tomorrow Night Before", category: "focus", difficulty: "normal", tier: "daily", xpBase: 30, goldBase: 8, statTarget: "focus", statGain: 2, isDaily: true, unlocksAtLevel: 1 },

    // ===== AI & TECH (AgentIQ) =====
    { title: "Build / Improve an AI Agent", category: "agentiq", difficulty: "hard", tier: "daily", xpBase: 120, goldBase: 30, statTarget: "agentIQ", statGain: 3, isDaily: true, unlocksAtLevel: 5 },
    { title: "Fine-tune a Model (LoRA/QLoRA)", category: "agentiq", difficulty: "legendary", tier: "custom", xpBase: 150, goldBase: 40, statTarget: "agentIQ", statGain: 5, isDaily: false, unlocksAtLevel: 10 },
    { title: "Write a Prompt Engineering Doc", category: "agentiq", difficulty: "normal", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "agentIQ", statGain: 2, isDaily: true, unlocksAtLevel: 5 },
    { title: "Deploy a Model to Production", category: "agentiq", difficulty: "legendary", tier: "custom", xpBase: 150, goldBase: 40, statTarget: "agentIQ", statGain: 5, isDaily: false, unlocksAtLevel: 10 },
    { title: "LangChain / LangSmith Practice", category: "agentiq", difficulty: "normal", tier: "daily", xpBase: 80, goldBase: 20, statTarget: "agentIQ", statGain: 2, isDaily: true, unlocksAtLevel: 5 },
    { title: "Read AI Research Paper", category: "agentiq", difficulty: "normal", tier: "daily", xpBase: 70, goldBase: 18, statTarget: "agentIQ", statGain: 2, isDaily: true, unlocksAtLevel: 5 },
    { title: "MLOps Task (Airflow/MLflow)", category: "agentiq", difficulty: "hard", tier: "daily", xpBase: 100, goldBase: 25, statTarget: "agentIQ", statGain: 3, isDaily: true, unlocksAtLevel: 10 },
    { title: "Kaggle Notebook Submission", category: "agentiq", difficulty: "hard", tier: "custom", xpBase: 100, goldBase: 25, statTarget: "agentIQ", statGain: 3, isDaily: false, unlocksAtLevel: 5 },
    ...
    { title: "Stay Under Budget All Week", category: "finance", difficulty: "hard", tier: "weekly", xpBase: 250, goldBase: 60, statTarget: "wealth", statGain: 3, isDaily: false, unlocksAtLevel: 1 },
    ...
    // ===== LEGENDARY QUESTS =====
    { title: "Complete Full Mock Technical Interview", category: "jobs", difficulty: "legendary", tier: "custom", xpBase: 500, goldBase: 100, statTarget: "hustle", statGain: 5, isDaily: false, unlocksAtLevel: 10 },
    { title: "Build and Push Portfolio Project Feature", category: "learning", difficulty: "legendary", tier: "custom", xpBase: 200, goldBase: 40, statTarget: "intel", statGain: 5, isDaily: false, unlocksAtLevel: 5 },
  ];
